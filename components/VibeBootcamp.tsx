...
const conceptAxes = {
  ja: [
    ...
    },
    {
      label: '四、運用',
      title: '公開 → 反応 → 更新 → また公開',
      body: 'Webca(ウェブカ)は、作って終わりじゃない。出して、反応を見て、少し直して、また出す。そのループが回り始めたとき、カードは資産になります。更新の手順とテンプレまで整えて、「育てられる状態」にしていきます。'
    }
  ],
  en: [
    {
...
const steps = {
  ja: [
    ...
    },
    {
      ...
      title: '公開して、育てる準備',
      items: [
        'Webca(ウェブカ)ページへ落とし込み（Notion / Webなど）',
        '名刺用QRの導線を整える',
...
const plans = {
  ja: [
    ...
    },
    {
      ...
      items: [
        '軽めチャット伴走（返信目安あり）',
        'Webca(ウェブカ)（またはプロフィール）を「1つ公開」まで伴走',
